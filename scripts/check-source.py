#!/usr/bin/env python3
"""Reject proof placeholders and prohibited declarations in GN and Solution.
...
def main():
    ...
    files = sorted((root / "GN").rglob("*.lean"))
    solution = root / "Solution.lean"
    if not files or not solution.is_file():
        print("Source guard requires GN/*.lean and Solution.lean", file=sys.stderr)
        return 1
